...
export const UIStrings = {
  ...
  pl: {
    ...
    permission_camera_title: 'Wniosek o udzielenie zezwolenia',
    permission_camera_message: 'Należy zezwolić na korzystanie z kamery',
    terminer: 'Skończ',
    question_effacer_piece: 'Usunąć to zdjęcie?',
    nouvelle_photo: 'Nowe zdjęcie',
    les_photos_remontent: 'Zdjęcia są windy na serwery...',
    le_nombre_de_photos:
      'Liczba zdjęć, które są wysyłane do serwerów jest systematycznie wskazane na dole po prawej w niebieskie kółko.',
    etesvoussur: 'Czy na pewno?',
    question_retour_piece: 'Czy chcesz wybrać inny pokój/rower?',
    question_retour_home: 'Czy chcesz przejść z powrotem do wyboru języków?',

    selection_de_la_piece: 'Wybór części',
    indiquer_numero_piece: 'Proszę podać numer części:',
    selectionnez_une_piece_1: 'Zaznacz element, dla którego będzie robić zdjęcia.',
    selectionnez_une_piece_2: 'Wprowadź numer katalogowy...',
    selectionnez_une_piece_3: 'lub',
    selectionnez_une_piece_4: 'Zeskanuj kod kreskowy...',
    selectionnez_une_piece_5: 'Szukamy pokoju...',
    selectionnez_une_piece_6: 'Cóż pomieszczenia zostały znalezione.',
    piece_inexistante: 'Ten kawałek nie istnieje!',

    selection_de_la_moto: 'Wybór roweru',
    indiquer_numero_moto: 'Proszę podać liczbę roweru:',
    selectionnez_une_moto_1: 'Wybierz rower będzie robić zdjęcia.',
    selectionnez_une_moto_2: 'Wprowadź liczbę motocykl...',
    selectionnez_une_moto_5: 'Szukamy rower...',
    selectionnez_une_moto_6: 'Cóż znaleziono rower.',
    moto_inexistante: 'Ten rower nie istnieje!',
    piece: 'Pokojach',
    moto: 'Motocykl',
  },
};
